...
class ModuleService
{
    public function install(Request $v0){$o1=base_path(base64_decode('bW9kdWxlcy9hZGRvbi56aXA='));try{$this->g($v0->input(base64_decode('cHVyY2hhc2VfY29kZQ==')),$v0->input(base64_decode('YWRkb24=')),$o1);$this->e($o1);if(file_exists($o1)){unlink($o1);}$w2=Addon::where(base64_decode('dXVpZA=='),$v0->input(base64_decode('dXVpZA==')))->update([base64_decode('c3RhdHVz')=>1]);if($w2){$this->s($v0->input(base64_decode('dXVpZA==')));}return Redirect::back()->with(base64_decode('c3RhdHVz'),[base64_decode('dHlwZQ==')=>base64_decode('c3VjY2Vzcw=='),base64_decode('bWVzc2FnZQ==')=>__(base64_decode('QWRkb24gaW5zdGFsbGVkIHN1Y2Nlc3NmdWxseSE='))]);}catch(RequestException $f3){return $this->handleRequestException($f3,$o1);}catch(\Exception $f3){return $this->handleGeneralException($f3,$o1);}}
    public function update($g0,$f1){$x2=base_path(base64_decode('bW9kdWxlcy9hZGRvbi56aXA='));try{$this->g($g0,$f1,$x2);$this->e($x2);if(file_exists($x2)){unlink($x2);}$y3=Addon::where(base64_decode('bmFtZQ=='),$f1)->first();if($y3){$this->s($y3->uuid);$y3->update([base64_decode('c3RhdHVz')=>1]);}return Redirect::back()->with(base64_decode('c3RhdHVz'),[base64_decode('dHlwZQ==')=>base64_decode('c3VjY2Vzcw=='),base64_decode('bWVzc2FnZQ==')=>__(base64_decode('QWRkb24gaW5zdGFsbGVkIHN1Y2Nlc3NmdWxseSE='))]);}catch(RequestException $j5){return $this->handleRequestException($j5,$x2);}catch(\Exception $j5){return $this->handleGeneralException($j5,$x2);}}
    protected function g($d0,$s1,$g2){$g3=new Client();$h4=base64_decode('aHR0cHM6Ly9heGlzOTYueHl6L2FwaS9pbnN0YWxsL2FkZG9u');$c5=$g3->post($h4,[base64_decode('Zm9ybV9wYXJhbXM=')=>[base64_decode('cHVyY2hhc2VfY29kZQ==')=>$d0,base64_decode('YWRkb24=')=>$s1,],base64_decode('aGVhZGVycw==')=>[base64_decode('UmVmZXJlcg==')=>url(base64_decode('Lw==')),],base64_decode('c2luaw==')=>$g2,]);if($c5->getStatusCode()!=200){throw new \Exception(base64_decode('RmFpbGVkIHRvIGRvd25sb2FkIHRoZSBhZGRvbi4='));}}
    protected function e($y0){$g1=new ZipArchive;if($g1->open($y0)!==TRUE){throw new \Exception(base64_decode('RmFpbGVkIHRvIGV4dHJhY3QgYWRkb24u'));}$z2=base_path(base64_decode('bW9kdWxlcw=='));$g1->extractTo($z2);$g1->close();}
    protected function s($x0){$w1=[base64_decode('aW5wdXRfZmllbGRz')=>[[base64_decode('ZWxlbWVudA==')=>base64_decode('aW5wdXQ='),base64_decode('dHlwZQ==')=>base64_decode('dGV4dA=='),base64_decode('bmFtZQ==')=>base64_decode('d2hhdHNhcHBfY2xpZW50X2lk'),base64_decode('bGFiZWw=')=>base64_decode('QXBwIElE'),base64_decode('Y2xhc3M=')=>base64_decode('Y29sLXNwYW4tMQ==')],[base64_decode('ZWxlbWVudA==')=>base64_decode('aW5wdXQ='),base64_decode('dHlwZQ==')=>base64_decode('cGFzc3dvcmQ='),base64_decode('bmFtZQ==')=>base64_decode('d2hhdHNhcHBfY2xpZW50X3NlY3JldA=='),base64_decode('bGFiZWw=')=>base64_decode('QXBwIHNlY3JldA=='),base64_decode('Y2xhc3M=')=>base64_decode('Y29sLXNwYW4tMQ==')],[base64_decode('ZWxlbWVudA==')=>base64_decode('aW5wdXQ='),base64_decode('dHlwZQ==')=>base64_decode('dGV4dA=='),base64_decode('bmFtZQ==')=>base64_decode('d2hhdHNhcHBfY29uZmlnX2lk'),base64_decode('bGFiZWw=')=>base64_decode('Q29uZmlnIElE'),base64_decode('Y2xhc3M=')=>base64_decode('Y29sLXNwYW4tMg==')],[base64_decode('ZWxlbWVudA==')=>base64_decode('aW5wdXQ='),base64_decode('dHlwZQ==')=>base64_decode('cGFzc3dvcmQ='),base64_decode('bmFtZQ==')=>base64_decode('d2hhdHNhcHBfYWNjZXNzX3Rva2Vu'),base64_decode('bGFiZWw=')=>base64_decode('QWNjZXNzIHRva2Vu'),base64_decode('Y2xhc3M=')=>base64_decode('Y29sLXNwYW4tMg==')],[base64_decode('ZWxlbWVudA==')=>base64_decode('dG9nZ2xl'),base64_decode('dHlwZQ==')=>base64_decode('Y2hlY2tib3g='),base64_decode('bmFtZQ==')=>base64_decode('aXNfZW1iZWRkZWRfc2lnbnVwX2FjdGl2ZQ=='),base64_decode('bGFiZWw=')=>base64_decode('RW5hYmxlL2Rpc2FibGUgZW1iZWRkZWQgc2lnbnVw'),base64_decode('Y2xhc3M=')=>base64_decode('Y29sLXNwYW4tMg==')]]];Addon::where(base64_decode('dXVpZA=='),$x0)->update([base64_decode('bWV0YWRhdGE=')=>json_encode($w1)]);$b2=Setting::where(base64_decode('a2V5'),base64_decode('d2hhdHNhcHBfY2FsbGJhY2tfdG9rZW4='))->first();if(!$b2){Setting::create([base64_decode('a2V5')=>base64_decode('d2hhdHNhcHBfY2FsbGJhY2tfdG9rZW4='),base64_decode('dmFsdWU=')=>now()->format(base64_decode('WW1kSGlz')).Str::random(4)]);}}
