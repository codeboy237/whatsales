...
class WhatsappService
{
     ...
     */
    public function sendMessage($contactUuId, $messageContent, $type="text", $buttons = [], $header = null, $footer = null)
    {
    ...
    public function updateBusinessProfile(Request $request){
        ...
        //$requestData['profile_picture_handle'] = $request->profile_picture_handle;
        ...
        if($responseObject->success === true){
            ...
            //$metadataArray['whatsapp']['business_profile']['profile_picture_handle'] = $request->profile_picture_handle;
